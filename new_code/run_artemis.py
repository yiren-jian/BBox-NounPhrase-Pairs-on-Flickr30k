...
if __name__ == '__main__':
    ...
    ####
    image_name = paints_ids_list[args.run][0]
    image_filename = '/home/yiren/wikiart' + image_name + '.jpg'
    image_id = paints_ids_list[args.run][1]
    ...
    with open("/home/yiren/artemis-speaker-tools-c/official_data/artemis_captions_clip.pkl", 'rb') as handle:
