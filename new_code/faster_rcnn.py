...
def parse_args():
    ...
    parser.add_argument('--run', default=0, type=int)      ##### this is a hack
    parser.add_argument('--start', default=0, type=int)      ##### this is a hack
    parser.add_argument('--end', default=0, type=int)      ##### this is a hack
...
def run_rcnn(im_file, image_id):
    args = parse_args()
    args.cfg_file='/home/yiren/Faster-R-CNN-with-model-pretrained-on-Visual-Genome/cfgs/res101.yml'
    args.classes_dir='/home/yiren/Faster-R-CNN-with-model-pretrained-on-Visual-Genome/data/genome/1600-400-20'
    # args.cuda = True      ##### on CPU machines
    args.load_dir='/home/yiren/Faster-R-CNN-with-model-pretrained-on-Visual-Genome/models'

    #### load the model
    classes, fasterRCNN = load_model(args)

    return get_detections_from_im(fasterRCNN, classes, im_file, image_id, args)
